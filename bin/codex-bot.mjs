...
async function setup() {
    ...
    try {
        ...
        if (configureRuntime) {
            ...
            values.DISCODE_PROVIDER = await setupValue(rl, { label: 'Provider codex/opencode/custom', flag: 'provider', current: existing.DISCODE_PROVIDER, fallback: 'codex', headless });
